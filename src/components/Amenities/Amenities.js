	...
	return (
		...
		{(!this.state.loading && this.state.length) &&
			...
			{window.innerWidth<768&&
				...
				<Specific active={true}  width="100%" height="100%" filter="brightness(100)"   text={img(this.state.selectedIndex!=-1&&this.state.AmenitiesArray[this.state.selectedIndex].amenities_icon)} activecolor={"#EA5B04"} />
				</div>
