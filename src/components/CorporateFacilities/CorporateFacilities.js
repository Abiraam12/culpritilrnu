...
// import Form1 from 'c:/Users/Noob/ivnueweb/src/components/form1/form1';
import Bindname from '../../components/bindname/bindname';
import Choosediv from '../../components/choosediv/choosediv';
// import Paginationview from 'c:/Users/Noob/ivnueweb/src/components/pagination/pagination';
		...
		return (
			...
			{(!this.state.loading && this.state.activelocationId)&&
				...
				{this.state.ListVenueType.map((item,i)=>
					...
					<Specific dummy={item.dontbind} width="100px" height="100px" filter="brightness(100)" undertext={item.venue_spec_name} specificvenue={()=>this.specificvenue(item)} text={img(item.venue_spec_icon)} active={(this.props.faclityId?this.props.faclityId:this.state.facilityId)==item.venue_spec_id} activecolor={"#EA5B04"} Skew={true}/>
