...
//   }
// );
 const myApiKey="AIzaSyDS9ePaBsFgdZt5v2wQrciYrLGhVJmvTWE";
...
componentWillReceiveProps(props){
  console.log("hahah props",props.mobroutes)
...
changeDrawer =  () => {
  this.setState({
    ...
    <NavLink to="/" onClick={this.changeDrawer} className={`${this.state.active=='home'?'active':''}`}>Home</NavLink>
     {/*<li onClick={()=>this.changeList('Action')}  className={`${this.state.active=='Action'?'active':''}`}>Action Items</li>*/}
    <NavLink to="/dashboard" onClick={this.changeDrawer} className={`${this.state.active=='Dashboard'?'active':''}`}>Dashboard</NavLink>
    {window.localStorage['LoginData']&&
       <NavLink to="/myvenues" onClick={this.changeDrawer} className={`${this.state.active=='MyVenues'?'active':''}`}>My Venues</NavLink>
     }
     {window.localStorage['LoginData']&&
       <NavLink to="/mycalendar" onClick={this.changeDrawer} className={`${this.state.active=='MyCalendar'?'active':''}`}>My Calendar</NavLink>
     }
    {/*<li onClick={()=>this.changeList('Enquiries')}  className={`${this.state.active=='Enquiries'?'active':''}`}>Enquiries</li>*/}
    <NavLink to="/referandearn" className={`${this.state.active=='Loyalty'?'active':''}`}>Refer & Earn</NavLink>
     {window.localStorage['LoginData']&&
    <NavLink to="/logout" onClick={this.changeDrawer} className={`${this.state.active=='Logout'?'active':'active'}`}>Logout</NavLink>
  }  {!window.localStorage['LoginData']&&
    <NavLink to="/login" onClick={this.changeDrawer} className={`${this.state.active=='Logout'?'active':'active'}`}>Login</NavLink>
  }
			...
			<div className="part1">
				{this.props.mobile&&
				<Link to="/" className="logo-div"><img src={logo} className="pic"/>
      ...
      <DropdownMenu>
        ...
        <DropdownItem><NavLink to="/myvenues">My Venues</NavLink></DropdownItem>
        <DropdownItem><NavLink to="/mycalendar">My Calendar</NavLink></DropdownItem>
        <DropdownItem><NavLink to="/logout">Logout</NavLink></DropdownItem>
    ...
    {!window.localStorage['LoginData']&&
      ...
      {/*
			...
			<div className="menu-div" onClick={this.drawerChange} > <img  className="menu-icon" src={menu}/> </div>
