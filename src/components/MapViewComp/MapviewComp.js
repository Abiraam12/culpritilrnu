...
// alert('lulabye');
	...
	render(){
		...
		return(
			<div  className="map_modal_ht">

    				<div id="map" style={{height:'100%'}} />
					<button style={{"visibility":'hidden',"z-index":"10000"}} className={`btnclass_search btn btn-primary btn-sm ${!search && 'd-none'}`}  type="button" id="clickSearch" ><img src={location}/></button>
					<input style={{"visibility":'hidden',"z-index":"100000"}} id="pac-input" className="controls MapviewInput" type="text" placeholder="Search Box" />
