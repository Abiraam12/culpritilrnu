...
class VideoPlayer extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
      <button onClick={()=>this.SlowFast(-0.1)}><img src={require('../icon/VideoPNG/LeftPNG.png')}/></button>
      </div>
      <div>
      <button onClick={()=>this.PausePlay()}><img src={require(this.state.PausePlay?'../icon/VideoPNG/PausePNG.png':'../icon/VideoPNG/PlayPNG.png')}/></button>
      </div>
      <div>
      <button onClick={()=>this.SlowFast(0.1)}><img src={require('../icon/VideoPNG/RightPNG.png')}/></button>
      </div>
