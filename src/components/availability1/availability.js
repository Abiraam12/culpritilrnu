...
var checkhourlyavailable=this.state.hourAvailType.includes("1");
		return (
          ...
          return(
                  <Specific disabled={this.state.businessform.slot_type=='2'} svg={true} width="100px" height="100px" filter="brightness(100)" undertext={obj.name} specificvenue={()=>this.receiveAvailability(obj,null,null,i)} text={obj.icon} active={obj.checked} activecolor={"#EA5B04"} Skew={false}/>
              )
          }
            )}
			  </div>
