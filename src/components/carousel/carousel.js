...
import ControlledLottie from '../../components/LottieComp/LottieComp';
...
class Carousel extends React.PureComponent {
  ...
  render() {
    ...
    return (
      ...
      <Col className="firstslide"  span={7} style={{padding:0}}>
      ...
      {sliderImages.map((obj)=>{
        return(
           <div className="innerResponsiveHeight" style={{height:this.props.height?this.props.height:'600px'}}>
      <img
      ...
      <Col className="secondslide"  span={5} style={{padding:0}}>
