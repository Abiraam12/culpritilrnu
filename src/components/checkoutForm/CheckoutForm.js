...
export default class CheckoutForm extends React.Component {
  constructor(props) {
    super(props);
  console.log(props);
    this.state = {amt:props.totalamount,venue_name:props.bookobj.trn_venue_name,category:props.bookobj.venue_cat_name,img:props.bookobj.photos.length>0?props.bookobj.photos[0].venue_image_path:require('../../images/imageloader.png'),currency:props.bookobj.price[0].trn_venue_price_currency,venue_id:props.bookobj.venue_id};
  }
