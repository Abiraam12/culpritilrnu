...
import ChooseAddVenueModal from '../chooseAddVenueModal/ChooseAddVenueModal';
...
export default class ModeForm extends React.Component {
 ...
 chooseVenue = (data) => {
	//  console.log("sdfsdfsf",data.type)
...
backdrop = () => {
	...
	console.log("bak",this.state.backdrop)
}
...
componentWillReceiveProps(props){
	console.log("form array mame",props.formArray)
	// console.log(props)
	if(props.formArray){
...
//choose venue
	...
	render() {
		console.log("sfsdfsfsfsd",this.state.modalVisible)
        ...
        
		{
			...
			<div>
			   ...
			   <ChooseAddVenueModal  type="choosevenue" modal={this.state.modalVisible} />
...
<div className="mode_form_btns" style={{textAlign:'center'}}>
    <button className="choose_venue_btn" type="button" style={{padding:'5px',color:"white"}} onClick={ this.chooseVenue }>CHOOSE VENUE</button>
    <button className="Register_btn" type="button" style={{padding:'5px',color:"white"}}>REGISTER FOR ILT</button>
</div>
    	</div>
			);
	}
