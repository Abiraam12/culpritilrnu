...
onClick={onClick} >
<img  alt="Arrow Text" className="side-arrow" src={arrowicon} style={{width:'25px',height:'11px','margin-left':'2px',transform:" rotate(270deg)", position:"absolute",right:"2px"}}/>
</div>
)
} 
