...
// import Trainer from '../../img/RChHGbK-bradley-cooper-wallpapers.jpg';
...
//       onClick={onClick} >
//           <img src={RightArrow} alt="Arrow Text" style={{width:'25px',height:'11px','margin-left':'2px',transform:" rotate(270deg)", position:"absolute",right:2px"}}/>
// </div>
// )
// } 
...
//         id:1,
//         name:"Arjun",
//         img:<img src={Trainer} alt="not available" />
//       },
//       {
//         id:2,
//         name:"Ranjith",
...
//       }],
//       categoryName:'',
//       // categoryDropdown:{id:'venue_cat_id','name':'venue_cat_name',dropdown:[]}
//       categoryDropdown:{value:'id',name:'name',dropdown:[{id:1,name:'Near You'},{id:2,name:'Certified'},{id:3,name:'Highly Rated'},{id:4,name:"Budget Trainer"}]},
...
//                               Near By 
//                                   <Popupbox buttonText="Soft Skills Trainer" sendPopupData={(data)=>this.loadCategoryDropdown(data)}  dropdown={this.state.categoryDropdown}  buttonColor={'transparent'} buttonTextColor={'black'} popupColor={'white'} popupTextColor={'black'}/>  
//                      </div>

//                  <div>
//               {this.state.trainer_det.map((det) => {
                
//                 return(
//                   console.log("popodfpsd",det),
//                   <div className="trainer_details">

//                       <div>
//                         <img src={det.img.props.src} alt="not available" style={{height:"100px",width:"100px"}}/>
//                         <span>{det.name}</span>
//                       </div>
...
//     {this.state.trainer_det.map((obj)=>{
      
//       return(
//           <div style={{flex:1}}>
//           <div style={{flex:.7,marginTop:'5px',borderRadius:'50px',position:'relative'}}>
//               <img src={Trainer} alt="Arrow Text" class="specialimg"/>
//            <Rate className="rateup" allowHalf defaultValue={3.5} />
//           </div>
//           </div>
...
//         {item&&item.trn_venue_type==2&&
//           <span>Per PAX</span>
//         }
//           {item&&item.trn_venue_type==3&&
//             <span>Per Seats</span>
//           }
//             {item&&(item.trn_venue_type!=2 && item.trn_venue_type!=3)&&
//               <span>Per {item.availability.length>0&&this.renderpricetype(item.availability[0].trn_availability_type)}</span>
//             }
//       &nbsp;&nbsp;
//       {item.price.length>0&&item.price[0].trn_venue_price_amt } - {item.price.length>0&&item.price[0].trn_venue_price_currency} </div>
//      <div className="amenitiesicoflex">{item.ameneties.length>0&&item.ameneties.map((obj)=>{
