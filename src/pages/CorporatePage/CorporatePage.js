...
this.loadwhere(data.venue_purpose_id,this.state.dovalue.venue_act_id);
  ...
  render() {
    return (
      <div className="HomePageDiv CorporatePageDiv">
...
<div className="home_dropdownflexItem">
      ...
      {this.state.userCatId==1 &&
            <Route path="/addIndividualform/" render={(props) => <IndividualForm {...props} userName={this.props.userName}/>}/>
      }

      {this.state.userCatId==2 &&
            <Route path="/addIndividualform/" render={(props) => <CorporateForm {...props} userName={this.props.userName}/>}/>
      }

      {/* <NearByPlayGround getlocation={this.props.latlng}  addvenueProps={(data)=>this.props.addvenueProps(data)}/> */}

      {this.state.searchdata&&
      <Homeslider scroll={this.props.scroll}  displaySlider={this.state.searchdata}/>
      }
{/* {this.state.searchedVenue&&this.state.searchedVenue.length>0 &&
<SoccerGround  addvenueProps={(data)=>this.props.addvenueProps(data)} scroll={this.props.scroll}  searchedVenue={this.state.searchedVenue}  categoryName={this.props.categoryName}/>
} */}
      <Footer/>
      </div>
      );
