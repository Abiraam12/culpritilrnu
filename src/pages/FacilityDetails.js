...
class FacilityDetailsPage extends Component {
...
// this.setState({facilityDetails})
    ...
    componentWillReceiveProps(props){
        ...
        //     var facilityDetails=this.state.facilityDetails;
        //     facilityDetails.roomname=props.facilityDetails.trn_venue_room_name;
...
render() {
    ...
    return (
        ...
        <table className='clr_blue faciliytformvenue' style={{'font-size':'16px','text-align':'left'}} cellpadding="15">
        <tr>
        <td>Room Name</td>
 ...
 <p className="errorblock">{this.state.validations['roomname'].errormsg}</p>
        ...
        <td>Seats</td>
        <td> 
        <Row style={{width:'100%','margin-left':'0px'}}className="seatsallocation">
        <div style={{'width':'15%'}}>
        ...
        <div style={{'font-size':'4vw','width':'15%',color:'#dcd2d2',margin: 'auto 0px'}}> &nbsp;Floor </div>
        <div style={{'width':'70%'}}>
        ...
        <tr>
        <td>Address</td>
        <td><textarea rows="4" className='form-control' name="address"
        value={address}
        ...
        value={landmark}
        onChange={(e)=>this.onChangeFacility(e,'trn_venue_room_landmark')} /> </div><div style={{'font-size':'4vw','width':'50%',margin: 'auto 0px'}} onClick={this.toggle}>&nbsp;&nbsp;&nbsp;Location Map </div></Row></td>
        </tr>      
    ...
    autoFocus: true
       ...
       onChange={(e)=>this.onChangeFacility(e,'trn_venue_room_mail')} /><p className="errorblock">{this.state.validations['mail'].errormsg}</p></td>
        ...
        <div className="webmodules" style={{float:'right',marginRight:'20px'}}>
