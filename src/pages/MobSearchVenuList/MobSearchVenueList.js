...
export default class MobSearchVenueList extends React.Component {
	...
	render() {
		return (
			...
			<SoccerGround_res venuecategory={this.state.venuecategory} category={this.state.whatobj} activeData={(data)=>this.setState({activeCategory:data})} dataarray={this.state.dataArray}/> 
			{this.state.activeCategory&&
			<HomeSliderContent sendLoginData={this.props.sendLoginData&&this.props.sendLoginData} activeCategory={this.state.activeCategory} />
			}
			</div>
