...
const HeaderContent=<div className="choose-text1">Please add your <span className="choose-text2">Skill</span> Details</div>;

export default class MobSpecTrainingDetailsForm extends React.Component {
